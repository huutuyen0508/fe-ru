...
import { registeredResidentVehicles } from './resident-pages'
import { getParkingFloorsSnapshot, ParkingMap } from './parking-map'
import { Modal, ResidentShell } from './shell'
...
export function ResidentAssistantPage() {
  ...
  const [vehicleModalOpen, setVehicleModalOpen] = useState(true)
  const [selectedVehicle, setSelectedVehicle] = useState<(typeof registeredResidentVehicles)[number] | null>(null)
