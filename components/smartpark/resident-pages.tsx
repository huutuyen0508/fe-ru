...
import { CalendarClock, CarFront, Check, ChevronDown, ChevronLeft, Clock3, Copy, Edit3, KeyRound, MapPin, MoreHorizontal, Plus, QrCode, Share2, ShieldCheck, Sparkles, Trash2, UserPlus, Users, X } from 'lucide-react'
...
export const registeredResidentVehicles = [{plate:'8ABC123',model:'Tesla Model 3',color:'Midnight Silver',primary:true,status:'Đang đỗ',space:'A-024'},{plate:'6PARK42',model:'Volvo XC40',color:'Crystal White',primary:false,status:'Vắng mặt',space:'A-024'}]
